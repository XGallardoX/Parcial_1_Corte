...
ABLATION = [
    ...
    dict(run_name="MLP_TFIDF-Bigrama_Alan_Osorio",         author="Alan Osorio",          notebook="04_Multilayer Perceptron _Alan_Osorio.ipynb",        encoding="TF-IDF Bigrama",   classifier="MLPClassifier",              best_hp="hidden_layers, lr", test_f1=0.7709, test_auc=0.8549, selected=False),
    dict(run_name="LDA_TFIDF-Bigrama_Alan_Osorio",         author="Alan Osorio",          notebook="04_Linear Discriminant Analysis_Alan_Osorio.ipynb", encoding="TF-IDF Bigrama",   classifier="LinearDiscriminantAnalysis", best_hp="n_components Bigrama",  test_f1=0.7312, test_auc=0.8092, selected=False),
    dict(run_name="DecisionTree_TFIDF-Bigrama_Alan_Osorio",author="Alan Osorio",          notebook="04_Decision_Tree_Alan_Osorio.ipynb",                encoding="TF-IDF Bigrama",   classifier="DecisionTreeClassifier",     best_hp="max_depth tuning",  test_f1=0.6471, test_auc=0.7097, selected=False),
    ...
    dict(run_name="DNN_TFIDF-Bigrama_Santiago",            author="Santiago Diaz",        notebook="04_models_DNN_santiagodiaz.ipynb",                  encoding="TF-IDF Bigrama",   classifier="DNN",                        best_hp="layers, lr, batch", test_f1=0.7773, test_auc=0.8608, selected=False),
    ...
    dict(run_name="RandomForest_TFIDF-Bigrama_Santiago",   author="Santiago Diaz",        notebook="04_models_RandomForest_santiagodiaz.ipynb",         encoding="TF-IDF Bigrama",   classifier="RandomForestClassifier",     best_hp="n_est, max_depth",  test_f1=0.7322, test_auc=0.8073, selected=False),
